...
impl<DatabaseErrorT> Inspector<DatabaseErrorT> for GasInspector {
...
mod tests {
    ...
    use crate::{inspectors::GasInspector, EVMData, Inspector};
    ...
    impl<DatabaseErrorT> Inspector<DatabaseErrorT> for StackInspector {
        fn initialize_interp(
            &mut self,
