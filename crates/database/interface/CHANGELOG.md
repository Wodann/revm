...
## [41.1.0](https://github.com/Wodann/revm/compare/revm-database-interface-v41.0.0...revm-database-interface-v41.1.0) - 2026-06-13

### Added

- *(database)* add database fallback mode for BAL misses ([#3754](https://github.com/Wodann/revm/pull/3754))
